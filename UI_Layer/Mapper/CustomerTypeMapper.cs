...
namespace UI_Layer.Mapper
{
    ...
    {
        public static async Task<CustomerTypeViewModel> DataModelToViewModel(CustomerTypeDM dataModel, UserManager<ApplicationUser> userManager)
        {
            var returnModel = new CustomerTypeViewModel();
        ...
        public static async Task<List<CustomerTypeViewModel>> DataModelToViewModel_List (List<CustomerTypeDM> dataModel, UserManager<ApplicationUser> userManager)
        {
            var returnModelList = new List<CustomerTypeViewModel>();
        ...
        public static CustomerTypeDM ViewModelToDataModel(CustomerTypeViewModel viewModel)
        {
            var returnModel = new CustomerTypeDM();
