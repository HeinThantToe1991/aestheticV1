...
namespace UI_Layer.Areas.BackendSystem.Controllers
{
    ...
    public class StaffController : Controller
    {
        ...
        public StaffController(IWebHostEnvironment webHostEnvironment, IStringLocalizer<Resource> localizer, ApplicationDbContext dbContext, UserManager<ApplicationUser> userManager)
        {
        ...
        [TypeFilter(typeof(CheckAuthenticationFilter))]
        [HttpPost]
        public async Task<ActionResult> Add([FromForm] StaffViewModel model)
        {
            ...
            try
            {
                ...
                if (registerStatus.Success)
                {
                    ...
                    var saveData = StaffMapper.ViewModelToDataModel(model);
        ...
        [HttpPost]
        public ActionResult StaffInfoReport(CustomerFilterViewModel viewModel)
        {
            ReturnMessageViewModel<StaffViewModel> data = new()
            {
                DataList = new List<StaffViewModel>(),
            ...
            try
            {
                    ...
                    if (viewModel.FilterEquation.Equals("Contain"))
                    {
                        switch (viewModel.Filter1Key)
                        {
                            case "Name":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.ApplicationUser.FullName.ToUpper().Contains(viewModel.Filter1Value1.ToUpper()))
                                        .Include(customerDm => customerDm.ApplicationUser)
                                        .ToList();
                                }
                            ...
                            case "Email":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.ApplicationUser.Email.ToUpper().Contains(viewModel.Filter1Value1.ToUpper()))
                            ...
                            case "Phone":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.ApplicationUser.PhoneNumber.Contains(viewModel.Filter1Value1))
                                        .Include(customerDm => customerDm.ApplicationUser).ToList();
                                }
                                break;
                            case "Address":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.Address.ToUpper().Contains(viewModel.Filter1Value1.ToUpper()))
                                        .Include(customerDm => customerDm.ApplicationUser).ToList();
                                }
                                break;
                        }
                    ...
                    else
                    {
                        switch (viewModel.Filter1Key)
                        {
                            case "Name":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.ApplicationUser.FullName.ToUpper().Equals(viewModel.Filter1Value1.ToUpper()))
                                        .Include(customerDm => customerDm.ApplicationUser)
                                        .ToList();
                                }
                            ...
                            case "Email":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.ApplicationUser.Email.ToUpper().Equals(viewModel.Filter1Value1.ToUpper()))
                                        .Include(customerDm => customerDm.ApplicationUser).ToList();
                                }
                                break;
                            case "Phone":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.ApplicationUser.PhoneNumber.Equals(viewModel.Filter1Value1))
                                        .Include(customerDm => customerDm.ApplicationUser).ToList();
                                }
                                break;
                            case "Address":
                                ...
                                {
                                    _list = _dbContext.Staff.Where(w => w.Address.ToUpper().Equals(viewModel.Filter1Value1.ToUpper()))
                                        .Include(customerDm => customerDm.ApplicationUser).ToList();
                                }
                                break;
                        }
                ...
                {
                    StaffViewModel outputVM = new StaffViewModel();
                    outputVM.Id = item.Id.ToString();
                    outputVM.LoginName = item.ApplicationUser.UserName;
        ...
        public ActionResult StaffInfoFilterReport(string viewModel)
        {
            if (viewModel == null)
            {
                return View();
            }
            var viewModelList = JsonConvert.DeserializeObject<List<StaffViewModel>>(viewModel);
